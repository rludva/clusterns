...
#
CLUSTER_NAME="ocp_v3.11_05"
CLUSTER_ALIAS="juichigo"

# Description is shared for all machines of cluster..
CVM_DESCRIPTION="RHEL 7.6 (OCP v3.11) 01 (juichi)"
...
CVM_WORKSTATION_MACHINE_OS_VARIANT="rhel7"
...
CVM_MASTER_MACHINE_OS_VARIANT="rhel7"
...
CVM_NODE_MACHINE_OS_VARIANT="rhel7"
