...
ssh kyuu-ni-ichi-master.example.com "ssh-keyscan -H kyuu-ni-ichi-node.example.com >> /root/.ssh/known_hosts"
ssh kyuu-ni-ichi-master.example.com "ssh-keygen -f /root/.ssh/id_rsa -N ''"
ssh kyuu-ni-ichi-master.example.com "sshpass -e ssh-copy-id -i /root/.ssh/id_rsa.pub kyuu-ni-ichi-node.example.com"
