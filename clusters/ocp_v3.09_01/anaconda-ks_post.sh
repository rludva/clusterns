...
# Generate installation script for OCP..
cat <<EOF > /root/bin/ocp
__TEMPLATE_ROOT_BIN_OCP__
EOF
chmod +x /root/bin/ocp

# Generate installation script for OCP..
cat <<EOF > /root/bin/ocp_upgrade_to_310
__TEMPLATE_ROOT_BIN_OCP_UPGRADE_TO_310__
EOF
chmod +x /root/bin/ocp_upgrade_to_310
