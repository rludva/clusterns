...
#
CLUSTER_NAME="ocp_v3.11_02"
CLUSTER_ALIAS="che"

# Description is shared for all machines of cluster..
CVM_DESCRIPTION="RHEL 7.5 (OCP v3.11) 02 (che)"
...
CVM_WORKSTATION_MACHINE_RAM="8000"
